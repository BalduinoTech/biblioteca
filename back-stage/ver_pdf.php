...
@$nome=$_POST['nome'];
                    ...
                    $i=0;
 $e="select * from arquivo a inner join livros  l on a.idlivro=l.IDLivro limit {$inicio},".$quantidade_pag;
                    $q=$pdo->prepare($e);
                    $q->execute();
 ...
 <td><a > <button class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $dados->idarquivo;?>"><i class="fa fa-eye"></i></button> <a/></td>

                       <td><a href="?url=editarpdf&cod=<?=$dados->idarquivo?>"> <button  onclick="return confirm('Deseja realmente editar ?')" class="btn btn-warning"><i class="fa fa-edit"></i></button> </a></td>



 <td><a href="?url=ver_pdf&cod=<?=$dados->idarquivo?>&sv=eli"> <button onclick="return confirm('Deseja realmente eliminar ?')"  class="btn btn-danger"><i class="fa fa-trash"></i></button> </a></td>
...
<div id="myModal<?php echo $dados->idarquivo;?>" class="modal fade" role="dialog" >
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <iframe src="../arquivos/<?php echo$dados->pdf;?>" style="width:100%;height:300px"></iframe>
